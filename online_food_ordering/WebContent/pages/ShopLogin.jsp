...
<div class="container">
<header>
<h1><span>HUNGRY??  ORDER FOOD ONLINE!!</span> LOGIN OR REGISTER AS FOODSHOPS</h1>
</header>
<div  class="form">
		<form id="contactform" action="ShopLoginSuccess.jsp" method="post">
		<br>
		...
		<p class="contact">
		<h1><a href="shopRegistration.jsp">Register Me</a></h1>
		</p>
